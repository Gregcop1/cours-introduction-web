...
export default {
  ...
  setup: () => {
    console.log('%cOulà, les choses se compliquent...', 'font-size: 1.8em');
    console.log('À nouveau, la boucle %cfor%c pourrait vous faire gagner beaucoup de temps.', 'font-weight: bold', 'font-weight: normal');
    ...
    console.log('Que diriez-vous de lui expliquer comment aller vers le Sud Ouest... Ça paraît tout à fait approprié dans ce niveau...');
